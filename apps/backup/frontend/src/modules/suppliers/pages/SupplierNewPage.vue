...
<template>
  <div class="d-flex flex-column gap-3">
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
      <div>
        <h5 class="fw-semibold mb-1">Nuevo Proveedor</h5>
        <div class="text-secondary small">Crea un proveedor</div>
      </div>
